...
public class BabyStuffFragment extends Fragment implements AsyncResponse{
    public static final String PREFS = "prefFile";


    //final static String url = "http://group8.hol.es/alcohol.php";
    final static String url = "http://picknpaysystemmyversion.000webhostapp.com/FetchBabyStuff.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init(UILConfig.config(BabyStuffFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(BabyStuffFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                SharedPreferences preferences = BabyStuffFragment.this.getActivity().getSharedPreferences(PREFS, 0);
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        BabyStuffFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(BabyStuffFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(BabyStuffFragment.this.getActivity(), productList, R.layout.product_row, dic);
